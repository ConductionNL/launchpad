...
- CLI commands: `php occ launchpad:export --scope=site --output=/tmp/launchpad-backup.zip` and `php occ launchpad:import --file=/tmp/launchpad-backup.zip [--preserve-uuids]`.
...
- `lib/Command/ExportCommand.php` (new) — CLI for `php occ launchpad:export`
- `lib/Command/ImportCommand.php` (new) — CLI for `php occ launchpad:import`
...
- `php occ launchpad:export --scope=site --output=/tmp/launchpad-backup.zip`
- `php occ launchpad:import --file=/tmp/launchpad-backup.zip [--preserve-uuids]`
