OC.L10N.register(
    ...
    "MyDash settings" : "LaunchPad settings",
    ...
    "To make MyDash the default app for users, go to Settings > Administration > Theming and select MyDash as the default app." : "To make LaunchPad the default app for users, go to Settings > Administration > Theming and select LaunchPad as the default app.",
    "View only" : "View only",
    ...
    "Download a versioned ZIP archive of all dashboards in this MyDash instance, or upload a previously exported archive to restore or migrate it. The archive is portable across Nextcloud installations." : "Download a versioned ZIP archive of all dashboards in this LaunchPad instance, or upload a previously exported archive to restore or migrate it. The archive is portable across Nextcloud installations.",
    ...
    "MyDash setup wizard" : "LaunchPad setup wizard",
    "Step {n} / {total}" : "Step {n} / {total}",
    "Welcome" : "Welcome",
    "Configure your MyDash instance with storage, group ordering, demo data, admin roles, and footer settings." : "Configure your LaunchPad instance with storage, group ordering, demo data, admin roles, and footer settings.",
    "Storage backend" : "Storage backend",
    "Choose how MyDash stores dashboard content." : "Choose how LaunchPad stores dashboard content.",
    "Database (default)" : "Database (default)",
    "Store dashboard content in the MyDash database table." : "Store dashboard content in the LaunchPad database table.",
    ...
    "Pick the order Nextcloud groups appear when MyDash routes users to a workspace." : "Pick the order Nextcloud groups appear when LaunchPad routes users to a workspace.",
    "Demo data" : "Demo data",
    ...
    "Assign the \"Dashboard Admin\" role to a Nextcloud group to delegate MyDash administration." : "Assign the \"Dashboard Admin\" role to a Nextcloud group to delegate LaunchPad administration.",
