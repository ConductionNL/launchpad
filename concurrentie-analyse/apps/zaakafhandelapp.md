# ZaakAfhandelApp — Feature Reference

**Application**: ZaakAfhandelApp
**Description**: Citizen-facing case management frontend — case status, document submission, communication.
**Software categories**: Case management system (`zaaksysteem`)
**Generated**: 2026-03-21

> Shares the zaaksysteem category with Procest but focuses on the citizen-facing interaction layer.
...
**Summary**: 88 TEC features, 935 evidence links, 154 additional (non-TEC) features
