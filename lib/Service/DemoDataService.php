<?php
/**
 * Launchpad DemoDataService.
 *
 * Imports `lib/Settings/launchpad_mock_register.json` — a `type: mock` descriptor generated from this
...
class DemoDataService {
	 ...
	 * @var string
	 */
	private const DESCRIPTOR = '/lib/Settings/launchpad_mock_register.json';
