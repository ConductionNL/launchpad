...
class ResourceControllerTest extends TestCase {
	...
	private function buildController(string $rawBody = ''): ResourceController {
		return new class($this->request, $this->service, $this->parser, $this->userSession, $this->groupManager, $this->logger, $rawBody, ) extends ResourceController {
	...
	private function buildMultipartController(?array $file): ResourceController {
		return new class($this->request, $this->service, $this->parser, $this->userSession, $this->groupManager, $this->logger, $file, ) extends ResourceController {
			public function __construct(
				IRequest $request,
				ResourceService $resourceService,
				ResourceUploadRequestParser $parser,
