OC.L10N.register(
    ...
    "MyDash settings" : "LaunchPad-instellingen",
    ...
    "To make MyDash the default app for users, go to Settings > Administration > Theming and select MyDash as the default app." : "Om LaunchPad als standaardapp voor gebruikers in te stellen, ga naar Instellingen > Beheer > Thema en selecteer LaunchPad als standaardapp.",
    ...
    "Download a versioned ZIP archive of all dashboards in this MyDash instance, or upload a previously exported archive to restore or migrate it. The archive is portable across Nextcloud installations." : "Download een geversioneerd ZIP-archief van alle dashboards in deze LaunchPad-instantie, of upload een eerder geëxporteerd archief om te herstellen of te migreren. Het archief is overdraagbaar tussen Nextcloud-installaties.",
    ...
    "%s's MyDash dashboards" : "LaunchPad-dashboards van %s",
    ...
    "MyDash setup wizard" : "LaunchPad installatiewizard",
    "Step {n} / {total}" : "Stap {n} / {total}",
    "Welcome" : "Welkom",
    "Configure your MyDash instance with storage, group ordering, demo data, admin roles, and footer settings." : "Configureer je LaunchPad met opslag, groepvolgorde, demo-data, beheerdersrollen en voettekstinstellingen.",
    "Storage backend" : "Opslag-backend",
    "Choose how MyDash stores dashboard content." : "Kies hoe LaunchPad dashboardinhoud opslaat.",
    "Database (default)" : "Database (standaard)",
    "Store dashboard content in the MyDash database table." : "Sla dashboardinhoud op in de LaunchPad-databasetabel.",
    ...
    "Pick the order Nextcloud groups appear when MyDash routes users to a workspace." : "Kies de volgorde waarin Nextcloud-groepen verschijnen wanneer LaunchPad gebruikers naar een werkruimte stuurt.",
    "Demo data" : "Demo-data",
    ...
    "Assign the \"Dashboard Admin\" role to a Nextcloud group to delegate MyDash administration." : "Wijs de rol \"Dashboardbeheerder\" toe aan een Nextcloud-groep om LaunchPad-beheer te delegeren.",
