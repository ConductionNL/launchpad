...
class WidgetApiControllerRoleTest extends TestCase
{
    ...
    private function makeController(): WidgetApiController
    {
        ...
        return new WidgetApiController(
            ...
            calendarWidgetService: $this->createMock(originalClassName: CalendarWidgetService::class),
            widgetPlacementService: $this->createMock(originalClassName: WidgetPlacementService::class),
