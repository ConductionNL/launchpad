OC.L10N.register(
    ...
    "cannot_modify_public_share" : "Cannot modify dashboard via public share",
    "unlock_throttled" : "Too many failed attempts. Please wait before trying again.",
    "Password required" : "Password required",
    "This dashboard is password protected. Enter the password to view it." : "This dashboard is password protected. Enter the password to view it.",
    "Password" : "Password",
    "Unlock" : "Unlock",
    ...
    "This shared dashboard is not available." : "This shared dashboard is not available.",
    "Not found" : "Not found",
    "This shared dashboard does not exist or has expired." : "This shared dashboard does not exist or has expired.",
    "An error occurred loading the shared dashboard." : "An error occurred loading the shared dashboard.",
    "— Choose —" : "— Choose —",
    ...
    "To make LaunchPad the default app for users, go to Settings > Administration > Theming and select LaunchPad as the default app." : "To make LaunchPad the default app for users, go to Settings > Administration > Theming and select LaunchPad as the default app.",
    "View only" : "View only",
    ...
    "Drag groups between the columns to control which Nextcloud groups LaunchPad uses, and in what order. The first active group becomes the user's primary workspace." : "Drag groups between the columns to control which Nextcloud groups LaunchPad uses, and in what order. The first active group becomes the user's primary workspace.",
    ...
    "Download a versioned ZIP archive of all dashboards in this LaunchPad instance, or upload a previously exported archive to restore or migrate it. The archive is portable across Nextcloud installations." : "Download a versioned ZIP archive of all dashboards in this LaunchPad instance, or upload a previously exported archive to restore or migrate it. The archive is portable across Nextcloud installations.",
    ...
    "Upload a Confluence HTML export ZIP archive. Each Confluence page becomes a LaunchPad dashboard with a single full-width text widget; the page hierarchy is mirrored using the dashboard tree." : "Upload a Confluence HTML export ZIP archive. Each Confluence page becomes a LaunchPad dashboard with a single full-width text widget; the page hierarchy is mirrored using the dashboard tree.",
    ...
    "LaunchPad setup wizard" : "LaunchPad setup wizard",
    "Step {n} / {total}" : "Step {n} / {total}",
    "Welcome" : "Welcome",
    "Configure your LaunchPad instance with storage, group ordering, demo data, admin roles, and footer settings." : "Configure your LaunchPad instance with storage, group ordering, demo data, admin roles, and footer settings.",
    "Storage backend" : "Storage backend",
    "Choose how LaunchPad stores dashboard content." : "Choose how LaunchPad stores dashboard content.",
    "Database (default)" : "Database (default)",
    "Store dashboard content in the LaunchPad database table." : "Store dashboard content in the LaunchPad database table.",
    ...
    "Pick the order Nextcloud groups appear when LaunchPad routes users to a workspace." : "Pick the order Nextcloud groups appear when LaunchPad routes users to a workspace.",
    "Demo data" : "Demo data",
    ...
    "Assign the \"Dashboard Admin\" role to a Nextcloud group to delegate LaunchPad administration." : "Assign the \"Dashboard Admin\" role to a Nextcloud group to delegate LaunchPad administration.",
    ...
    "Role-based default layouts" : "Role-based default layouts",
    "Define the default grid positions for each group's widgets. New users whose group has no admin template will receive these positions as their starting layout." : "Define the default grid positions for each group's widgets. New users whose group has no admin template will receive these positions as their starting layout.",
    "No layout defaults configured" : "No layout defaults configured",
    "Add layout default rows to seed role-based starting dashboards for new users." : "Add layout default rows to seed role-based starting dashboards for new users.",
    "Add layout default" : "Add layout default",
    "Edit layout default" : "Edit layout default",
    "{x},{y} {w}×{h}" : "{x},{y} {w}×{h}",
    "Compulsory" : "Compulsory",
    "Compulsory (user cannot remove this widget)" : "Compulsory (user cannot remove this widget)",
    "Widget ID" : "Widget ID",
    "Grid X" : "Grid X",
    "Grid Y" : "Grid Y",
    ...
    "Delete layout default" : "Delete layout default",
    "Delete layout default for \"{group}\" / \"{widget}\"?" : "Delete layout default for \"{group}\" / \"{widget}\"?",
    "Delete role permission" : "Delete role permission",
    "Delete role permission for group \"{group}\"?" : "Delete role permission for group \"{group}\"?",
    "Administration areas" : "Administration areas",
    "Templates" : "Templates",
    ...
    "Widgets with visibility rules" : "Widgets with visibility rules",
    "Every widget placement that has at least one conditional visibility rule, across all dashboards." : "Every widget placement that has at least one conditional visibility rule, across all dashboards.",
    "No visibility rules yet" : "No visibility rules yet",
    "When users add conditional visibility rules to their widgets, they appear here." : "When users add conditional visibility rules to their widgets, they appear here.",
    "Rules" : "Rules",
    "Include" : "Include",
    "Exclude" : "Exclude",
    "Unknown dashboard" : "Unknown dashboard",
    "Organisation sharing defaults" : "Organisation sharing defaults",
    "Set the default permission level applied to new shares and the groups every dashboard is automatically shared with." : "Set the default permission level applied to new shares and the groups every dashboard is automatically shared with.",
    "Default share permission level" : "Default share permission level",
    "Forced share groups" : "Forced share groups",
    "Select groups (leave empty for none)" : "Select groups (leave empty for none)",
    "Members of these groups always receive every newly created dashboard." : "Members of these groups always receive every newly created dashboard.",
    "Prometheus metrics" : "Prometheus metrics",
    "Copy" : "Copy",
    "Copied" : "Copied",
    "Failed to load metrics." : "Failed to load metrics.",
    "Health" : "Health",
    "Checking…" : "Checking…",
    "Healthy" : "Healthy",
    "Degraded" : "Degraded",
    "Legacy widget bridge" : "Legacy widget bridge",
    "Enable the legacy widget bridge" : "Enable the legacy widget bridge",
    "When disabled, existing dashboards that embed bridged Nextcloud widgets render an \"Unavailable\" state until the bridge is re-enabled." : "When disabled, existing dashboards that embed bridged Nextcloud widgets render an \"Unavailable\" state until the bridge is re-enabled.",
    "Visibility rules" : "Visibility rules",
    "Visibility rules…" : "Visibility rules…",
    "Show or hide this widget based on group membership, time of day, date range, or a user attribute. Include rules use OR logic; exclude rules use AND logic." : "Show or hide this widget based on group membership, time of day, date range, or a user attribute. Include rules use OR logic; exclude rules use AND logic.",
    "Remove rule" : "Remove rule",
    "No visibility rules yet — this widget is always shown." : "No visibility rules yet — this widget is always shown.",
    ...
    "Include (show when matched)" : "Include (show when matched)",
    "Exclude (hide when matched)" : "Exclude (hide when matched)",
    "Groups" : "Groups",
    ...
    "Browse every widget you can add to a dashboard, grouped by category." : "Browse every widget you can add to a dashboard, grouped by category.",
    "All" : "All",
    "Built-in" : "Built-in",
    "Custom Tiles" : "Custom Tiles",
    "Bridge" : "Bridge",
    "No widgets match this filter" : "No widgets match this filter",
    "Catalog" : "Catalog",
    "General" : "General",
    "Group dashboards" : "Group dashboards",
    "Manage dashboards shared with a Nextcloud group. The “Default group” row controls the org-wide default dashboard set." : "Manage dashboards shared with a Nextcloud group. The “Default group” row controls the org-wide default dashboard set.",
    "Loading groups" : "Loading groups",
    "No groups configured" : "No groups configured",
    "Add Nextcloud groups via the Sharing tab to start managing per-group dashboards." : "Add Nextcloud groups via the Sharing tab to start managing per-group dashboards.",
    "View" : "View",
    "Create group dashboard" : "Create group dashboard",
    "Manage" : "Manage",
    "Default group" : "Default group",
    "Failed to load groups" : "Failed to load groups",
    "Failed to load group dashboards" : "Failed to load group dashboards",
    "Failed to delete dashboard" : "Failed to delete dashboard",
    "Last dashboard cannot be deleted" : "Last dashboard cannot be deleted",
    "Name" : "Name",
    "Icon (Material Design name)" : "Icon (Material Design name)",
    "Layout template" : "Layout template",
    "Blank dashboard" : "Blank dashboard",
    "KPI overview" : "KPI overview",
    "People & teams" : "People & teams",
    "Set as the group default dashboard" : "Set as the group default dashboard",
    "Cancel" : "Cancel",
    "Create" : "Create",
    "Creating…" : "Creating…",
    "Name must be at least 2 characters" : "Name must be at least 2 characters",
    "Name must be at most 64 characters" : "Name must be at most 64 characters",
    "Manage dashboards for {group}" : "Manage dashboards for {group}",
    "Loading dashboards" : "Loading dashboards",
    "No dashboards in this group yet" : "No dashboards in this group yet",
    "Default" : "Default",
    "Set as default" : "Set as default",
    "Rename" : "Rename",
    "Delete" : "Delete",
    ...
    "Point a wall display or reception screen at a playlist URL to rotate dashboards chrome-less and unattended." : "Point a wall display or reception screen at a playlist URL to rotate dashboards chrome-less and unattended.",
    "_%n dashboard_::_%n dashboards_" : ["%n dashboard", "%n dashboards"],
    "refresh every {seconds}s" : "refresh every {seconds}s",
    "Copy URL" : "Copy URL",
    "Revoke" : "Revoke",
    "No kiosk playlists yet" : "No kiosk playlists yet",
    "Create a playlist to put dashboards on a wall display." : "Create a playlist to put dashboards on a wall display.",
    "Could not load kiosk playlists" : "Could not load kiosk playlists",
    "Kiosk playlist saved" : "Kiosk playlist saved",
    "You may only add dashboards you own" : "You may only add dashboards you own",
    "Could not save kiosk playlist" : "Could not save kiosk playlist",
    "Kiosk URL copied" : "Kiosk URL copied",
    "Could not copy the URL" : "Could not copy the URL",
    "Kiosk playlist revoked" : "Kiosk playlist revoked",
    "Could not revoke the playlist" : "Could not revoke the playlist",
    "Edit kiosk playlist" : "Edit kiosk playlist",
    "New kiosk playlist" : "New kiosk playlist",
    "Playlist name" : "Playlist name",
    "Add a dashboard" : "Add a dashboard",
    "Dwell (seconds)" : "Dwell (seconds)",
    "Remove entry" : "Remove entry",
    "Add at least one dashboard to the rotation." : "Add at least one dashboard to the rotation.",
    ...
    "Category filter (comma separated CPV / category ids)" : "Category filter (comma separated CPV / category ids)",
    "e.g. 30190000, 48000000" : "e.g. 30190000, 48000000",
    "Department filter (comma separated cost-centre ids)" : "Department filter (comma separated cost-centre ids)",
    "Vendor filter (comma separated supplier ids)" : "Vendor filter (comma separated supplier ids)",
    "Drill-through behaviour" : "Drill-through behaviour",
    "Open detail panel inside launchpad" : "Open detail panel inside launchpad",
    "Deep-link to the owning app" : "Deep-link to the owning app",
    "Surface attached evidence documents" : "Surface attached evidence documents",
    "Show AI-generated narrative (via local LLM)" : "Show AI-generated narrative (via local LLM)",
    "Invalid view mode" : "Invalid view mode",
    "Invalid period" : "Invalid period",
    "Reporting period" : "Reporting period",
    "Loading spend data…" : "Loading spend data…",
    "No spend data — financeq is not installed" : "No spend data — financeq is not installed",
    "No spend recorded for the selected period" : "No spend recorded for the selected period",
    "Total spend" : "Total spend",
    "Categories" : "Categories",
    "Spend trend" : "Spend trend",
    "No vendor data — procest is not installed" : "No vendor data — procest is not installed",
    "No vendor commitments for the selected period" : "No vendor commitments for the selected period",
