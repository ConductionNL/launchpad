...
- Name: label-widget.spec.ts >> label widget >> add → fill → save → reopen round-trips all six fields
- Location: tests/e2e/label-widget.spec.ts:25:6
  ...
  - dialog "Add Widget" [ref=e370]:
    ...
    - generic [ref=e374]:
      - dialog "Add Widget" [ref=e376]:
        ...
        - generic [ref=e379]:
          - generic [ref=e381]:
            - textbox "Label text" [ref=e382] [cursor=pointer]: Sales Q4
            - generic: Label text
          - generic [ref=e384]:
            - textbox "Font size" [active] [ref=e385]:
              - /placeholder: 16px
              - text: 24px
            - generic: Font size
          - generic [ref=e386] [cursor=pointer]:
            - text: Color
            - textbox "Color" [ref=e387]: "#ff0000"
