OC.L10N.register(
    ...
    "cannot_modify_public_share" : "Dashboard kan niet worden gewijzigd via een openbare koppeling",
    "unlock_throttled" : "Te veel mislukte pogingen. Wacht even voordat je het opnieuw probeert.",
    "Password required" : "Wachtwoord vereist",
    "This dashboard is password protected. Enter the password to view it." : "Dit dashboard is beveiligd met een wachtwoord. Voer het wachtwoord in om het te bekijken.",
    "Password" : "Wachtwoord",
    "Unlock" : "Ontgrendelen",
    "Read-only view" : "Alleen-lezen weergave",
    "Dashboard loaded successfully." : "Dashboard is succesvol geladen.",
    "Incorrect password. Please try again." : "Onjuist wachtwoord. Probeer het opnieuw.",
    "Failed to verify password." : "Wachtwoordverificatie mislukt.",
    "Not available" : "Niet beschikbaar",
    "This shared dashboard is not available." : "Dit gedeelde dashboard is niet beschikbaar.",
    "Not found" : "Niet gevonden",
    "This shared dashboard does not exist or has expired." : "Dit gedeelde dashboard bestaat niet of is verlopen.",
    "An error occurred loading the shared dashboard." : "Er is een fout opgetreden bij het laden van het gedeelde dashboard.",
    "— Choose —" : "— Kies —",
    ...
    "LaunchPad settings" : "LaunchPad-instellingen",
    ...
    "To make LaunchPad the default app for users, go to Settings > Administration > Theming and select LaunchPad as the default app." : "Om LaunchPad als standaardapp voor gebruikers in te stellen, ga naar Instellingen > Beheer > Thema en selecteer LaunchPad als standaardapp.",
    ...
    "Drag groups between the columns to control which Nextcloud groups LaunchPad uses, and in what order. The first active group becomes the user's primary workspace." : "Sleep groepen tussen de kolommen om te bepalen welke Nextcloud-groepen LaunchPad gebruikt en in welke volgorde. De eerste actieve groep wordt de primaire werkruimte van de gebruiker.",
    ...
    "Download a versioned ZIP archive of all dashboards in this LaunchPad instance, or upload a previously exported archive to restore or migrate it. The archive is portable across Nextcloud installations." : "Download een geversioneerd ZIP-archief van alle dashboards in deze LaunchPad-instantie, of upload een eerder geëxporteerd archief om te herstellen of te migreren. Het archief is overdraagbaar tussen Nextcloud-installaties.",
    ...
    "Upload a Confluence HTML export ZIP archive. Each Confluence page becomes a LaunchPad dashboard with a single full-width text widget; the page hierarchy is mirrored using the dashboard tree." : "Upload een Confluence HTML-export-ZIP. Elke Confluence-pagina wordt een LaunchPad-dashboard met één volledige-breedte tekst-widget; de paginahiërarchie wordt overgenomen via de dashboard-boom.",
    ...
    "%s's LaunchPad dashboards" : "LaunchPad-dashboards van %s",
    ...
    "Assign the \"Dashboard Admin\" role to a Nextcloud group to delegate LaunchPad administration." : "Wijs de rol \"Dashboardbeheerder\" toe aan een Nextcloud-groep om LaunchPad-beheer te delegeren.",
    ...
    "Layout saved" : "Lay-out opgeslagen",
    "Failed to save layout" : "Lay-out opslaan mislukt",
    "Role-based default layouts" : "Rolgebaseerde standaardlay-outs",
    "Define the default grid positions for each group's widgets. New users whose group has no admin template will receive these positions as their starting layout." : "Definieer de standaard rasterposities voor de widgets van elke groep. Nieuwe gebruikers wier groep geen beheerdersjabloon heeft, ontvangen deze posities als startlay-out.",
    "No layout defaults configured" : "Geen standaardlay-outs geconfigureerd",
    "Add layout default rows to seed role-based starting dashboards for new users." : "Voeg standaardlay-outrijen toe om rolgebaseerde startdashboards voor nieuwe gebruikers te seeden.",
    "Add layout default" : "Standaardlay-out toevoegen",
    "Edit layout default" : "Standaardlay-out bewerken",
    "{x},{y} {w}×{h}" : "{x},{y} {w}×{h}",
    "Compulsory" : "Verplicht",
    "Compulsory (user cannot remove this widget)" : "Verplicht (gebruiker kan dit widget niet verwijderen)",
    "Widget ID" : "Widget-ID",
    "Grid X" : "Raster X",
    "Grid Y" : "Raster Y",
    "Width (columns)" : "Breedte (kolommen)",
    "Height (rows)" : "Hoogte (rijen)",
    "Sort order" : "Sorteervolgorde",
    "Delete layout default" : "Standaardlay-out verwijderen",
    "Delete layout default for \"{group}\" / \"{widget}\"?" : "Standaardlay-out voor \"{group}\" / \"{widget}\" verwijderen?",
    "Delete role permission" : "Rolrecht verwijderen",
    "Delete role permission for group \"{group}\"?" : "Rolrecht voor groep \"{group}\" verwijderen?",
    "Administration areas" : "Beheergebieden",
    "Templates" : "Sjablonen",
    "Operations" : "Beheer",
    "Roles & Permissions" : "Rollen en rechten",
    "Versioning & Audit" : "Versiebeheer en audit",
    "Sharing" : "Delen",
    "Org navigation" : "Organisatienavigatie",
    "Widgets with visibility rules" : "Widgets met zichtbaarheidsregels",
    "Every widget placement that has at least one conditional visibility rule, across all dashboards." : "Elke widgetplaatsing met ten minste één voorwaardelijke zichtbaarheidsregel, op alle dashboards.",
    "No visibility rules yet" : "Nog geen zichtbaarheidsregels",
    "When users add conditional visibility rules to their widgets, they appear here." : "Wanneer gebruikers voorwaardelijke zichtbaarheidsregels aan hun widgets toevoegen, verschijnen ze hier.",
    "Rules" : "Regels",
    "Include" : "Insluiten",
    "Exclude" : "Uitsluiten",
    "Unknown dashboard" : "Onbekend dashboard",
    "Organisation sharing defaults" : "Standaardinstellingen voor delen in de organisatie",
    "Set the default permission level applied to new shares and the groups every dashboard is automatically shared with." : "Stel het standaard rechtenniveau in voor nieuwe gedeelde items en de groepen waarmee elk dashboard automatisch wordt gedeeld.",
    "Default share permission level" : "Standaard rechtenniveau voor delen",
    "Forced share groups" : "Verplichte deelgroepen",
    "Select groups (leave empty for none)" : "Selecteer groepen (leeg laten voor geen)",
    "Members of these groups always receive every newly created dashboard." : "Leden van deze groepen ontvangen altijd elk nieuw aangemaakt dashboard.",
    "Prometheus metrics" : "Prometheus-metrieken",
    "Copy" : "Kopiëren",
    "Copied" : "Gekopieerd",
    "Failed to load metrics." : "Kan metrieken niet laden.",
    "Health" : "Status",
    "Checking…" : "Controleren…",
    "Healthy" : "Gezond",
    "Degraded" : "Verminderd",
    "Legacy widget bridge" : "Verouderde widgetbrug",
    "Enable the legacy widget bridge" : "Verouderde widgetbrug inschakelen",
    "When disabled, existing dashboards that embed bridged Nextcloud widgets render an \"Unavailable\" state until the bridge is re-enabled." : "Indien uitgeschakeld tonen bestaande dashboards met overbrugde Nextcloud-widgets een status \"Niet beschikbaar\" totdat de brug weer wordt ingeschakeld.",
    "Visibility rules" : "Zichtbaarheidsregels",
    "Visibility rules…" : "Zichtbaarheidsregels…",
    "Show or hide this widget based on group membership, time of day, date range, or a user attribute. Include rules use OR logic; exclude rules use AND logic." : "Toon of verberg deze widget op basis van groepslidmaatschap, tijdstip, datumbereik of een gebruikerskenmerk. Insluitregels gebruiken OF-logica; uitsluitregels gebruiken EN-logica.",
    "Remove rule" : "Regel verwijderen",
    "No visibility rules yet — this widget is always shown." : "Nog geen zichtbaarheidsregels — deze widget wordt altijd getoond.",
    ...
    "Include (show when matched)" : "Insluiten (tonen bij overeenkomst)",
    "Exclude (hide when matched)" : "Uitsluiten (verbergen bij overeenkomst)",
    "Groups" : "Groepen",
    "Select groups" : "Selecteer groepen",
    "Start time (HH:MM)" : "Begintijd (UU:MM)",
    "End time (HH:MM)" : "Eindtijd (UU:MM)",
    "Start date (YYYY-MM-DD)" : "Begindatum (JJJJ-MM-DD)",
    "End date (YYYY-MM-DD)" : "Einddatum (JJJJ-MM-DD)",
    "Attribute" : "Kenmerk",
    "Equals value" : "Gelijk aan waarde",
    "Add rule" : "Regel toevoegen",
    "Widget catalog" : "Widgetcatalogus",
    "Browse every widget you can add to a dashboard, grouped by category." : "Blader door elke widget die je aan een dashboard kunt toevoegen, gegroepeerd per categorie.",
    "All" : "Alle",
    "Built-in" : "Ingebouwd",
    "Custom Tiles" : "Aangepaste tegels",
    "Bridge" : "Brug",
    "No widgets match this filter" : "Geen widgets komen overeen met dit filter",
    "Catalog" : "Catalogus",
    "General" : "Algemeen",
    "Group dashboards" : "Groepsdashboards",
    "Manage dashboards shared with a Nextcloud group. The “Default group” row controls the org-wide default dashboard set." : "Beheer dashboards die met een Nextcloud-groep worden gedeeld. De rij “Standaardgroep” regelt de organisatiebrede standaard dashboards.",
    "Loading groups" : "Groepen laden",
    "No groups configured" : "Geen groepen geconfigureerd",
    "Add Nextcloud groups via the Sharing tab to start managing per-group dashboards." : "Voeg Nextcloud-groepen toe via het tabblad Delen om per groep dashboards te beheren.",
    "View" : "Bekijken",
    "Create group dashboard" : "Groepsdashboard aanmaken",
    "Manage" : "Beheren",
    "Default group" : "Standaardgroep",
    "Failed to load groups" : "Laden van groepen mislukt",
    "Failed to load group dashboards" : "Laden van groepsdashboards mislukt",
    "Failed to delete dashboard" : "Verwijderen van dashboard mislukt",
    "Last dashboard cannot be deleted" : "Het laatste dashboard kan niet worden verwijderd",
    "Name" : "Naam",
    "Icon (Material Design name)" : "Pictogram (Material Design-naam)",
    "Layout template" : "Lay-outsjabloon",
    "Blank dashboard" : "Leeg dashboard",
    "KPI overview" : "KPI-overzicht",
    "People & teams" : "Mensen & teams",
    "Set as the group default dashboard" : "Instellen als standaard groepsdashboard",
    "Cancel" : "Annuleren",
    "Create" : "Aanmaken",
    "Creating…" : "Bezig met aanmaken…",
    "Name must be at least 2 characters" : "Naam moet minstens 2 tekens bevatten",
    "Name must be at most 64 characters" : "Naam mag maximaal 64 tekens bevatten",
    "Manage dashboards for {group}" : "Dashboards beheren voor {group}",
    "Loading dashboards" : "Dashboards laden",
    "No dashboards in this group yet" : "Nog geen dashboards in deze groep",
    "Default" : "Standaard",
    ...
    "Kiosk playlists" : "Kioskafspeellijsten",
    "New playlist" : "Nieuwe afspeellijst",
    "Point a wall display or reception screen at a playlist URL to rotate dashboards chrome-less and unattended." : "Richt een wanddisplay of receptiescherm op een afspeellijst-URL om dashboards onbemand en zonder schermrand te laten roteren.",
    "_%n dashboard_::_%n dashboards_" : ["%n dashboard", "%n dashboards"],
    "refresh every {seconds}s" : "ververst elke {seconds}s",
    "Copy URL" : "URL kopiëren",
    "Revoke" : "Intrekken",
    "No kiosk playlists yet" : "Nog geen kioskafspeellijsten",
    "Create a playlist to put dashboards on a wall display." : "Maak een afspeellijst om dashboards op een wanddisplay te tonen.",
    "Could not load kiosk playlists" : "Kon de kioskafspeellijsten niet laden",
    "Kiosk playlist saved" : "Kioskafspeellijst opgeslagen",
    "You may only add dashboards you own" : "Je kunt alleen dashboards toevoegen die je zelf beheert",
    "Could not save kiosk playlist" : "Kon de kioskafspeellijst niet opslaan",
    "Kiosk URL copied" : "Kiosk-URL gekopieerd",
    "Could not copy the URL" : "Kon de URL niet kopiëren",
    "Kiosk playlist revoked" : "Kioskafspeellijst ingetrokken",
    "Could not revoke the playlist" : "Kon de afspeellijst niet intrekken",
    "Edit kiosk playlist" : "Kioskafspeellijst bewerken",
    "New kiosk playlist" : "Nieuwe kioskafspeellijst",
    "Playlist name" : "Naam afspeellijst",
    "Add a dashboard" : "Dashboard toevoegen",
    "Dwell (seconds)" : "Weergaveduur (seconden)",
    "Remove entry" : "Item verwijderen",
    "Add at least one dashboard to the rotation." : "Voeg minstens één dashboard aan de rotatie toe.",
    "Refresh interval (seconds)" : "Ververstinterval (seconden)",
    "Reconnecting…" : "Opnieuw verbinden…",
    "Waiting for content…" : "Wachten op inhoud…",
    "Spend analytics" : "Uitgavenanalyse",
    "View mode" : "Weergavemodus",
    "Period" : "Periode",
    "Summary" : "Samenvatting",
    "Trend" : "Trend",
    "Top vendors" : "Belangrijkste leveranciers",
    "Top categories" : "Belangrijkste categorieën",
    "This month" : "Deze maand",
    "This quarter" : "Dit kwartaal",
    "Year to date" : "Jaar tot heden",
    "Fiscal year" : "Boekjaar",
    "Category filter (comma separated CPV / category ids)" : "Categoriefilter (door komma's gescheiden CPV- / categorie-id's)",
    "e.g. 30190000, 48000000" : "bijv. 30190000, 48000000",
    "Department filter (comma separated cost-centre ids)" : "Afdelingsfilter (door komma's gescheiden kostenplaats-id's)",
    "Vendor filter (comma separated supplier ids)" : "Leveranciersfilter (door komma's gescheiden leverancier-id's)",
    "Drill-through behaviour" : "Inzoomgedrag",
    "Open detail panel inside launchpad" : "Detailpaneel binnen launchpad openen",
    "Deep-link to the owning app" : "Diepe link naar de bronapp",
    "Surface attached evidence documents" : "Bijgevoegde bewijsdocumenten tonen",
    "Show AI-generated narrative (via local LLM)" : "AI-gegenereerde toelichting tonen (via lokale LLM)",
    "Invalid view mode" : "Ongeldige weergavemodus",
    "Invalid period" : "Ongeldige periode",
    "Reporting period" : "Rapportageperiode",
    "Loading spend data…" : "Uitgavengegevens laden…",
    "No spend data — financeq is not installed" : "Geen uitgavengegevens — financeq is niet geïnstalleerd",
    "No spend recorded for the selected period" : "Geen uitgaven geregistreerd voor de geselecteerde periode",
    "Total spend" : "Totale uitgaven",
    "Categories" : "Categorieën",
    "Spend trend" : "Uitgaventrend",
    "No vendor data — procest is not installed" : "Geen leveranciersgegevens — procest is niet geïnstalleerd",
    "No vendor commitments for the selected period" : "Geen leveranciersverplichtingen voor de geselecteerde periode",
    ...
    "launchpad.pages.adminTemplates" : "Sjablonen",
    "launchpad.pages.adminSettings" : "Instellingen",
    "Reports": "Rapporten",
    ...
    "Shared with a group": "Gedeeld met een groep",
    "Admin templates": "Beheerdersjablonen",
    "Who they belong to": "Van wie ze zijn",
    "Kind": "Soort",
    "Version": "Versie",
    ...
    "Dashboard registry": "Dashboardregister",
    "Connect a registry to install dashboards that other organisations published.": "Koppel een register om dashboards te installeren die andere organisaties publiceerden.",
    "Enable OpenRegister so you can reach a registry.": "Schakel OpenRegister in om een register te bereiken.",
    "Registry URL": "Register-URL",
    "Use the address of the instance that publishes the templates.": "Gebruik het adres van de omgeving die de sjablonen publiceert.",
    "Register": "Register",
    "Leave empty to use launchpad.": "Laat leeg om launchpad te gebruiken.",
    "Access token": "Toegangstoken",
    "A token is set. Enter a new one to replace it.": "Er is een token ingesteld. Voer een nieuw token in om het te vervangen.",
    "No token is set. Add one if the registry asks for it.": "Er is geen token ingesteld. Voeg er een toe als het register erom vraagt.",
    "Save registry": "Register opslaan",
    "Remove token": "Token verwijderen",
    "Registry saved.": "Register opgeslagen.",
    "Token removed.": "Token verwijderd.",
    "The registry could not be saved.": "Het register kon niet worden opgeslagen.",
