...
- [x] Task 9: Newman/Postman — added "Role-Feature Permissions" folder to `tests/integration/launchpad.postman_collection.json` (5 entries: GET permissions, POST create, POST non-admin 403, GET layout defaults, GET widgets filtered)
