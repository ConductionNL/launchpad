# Retrofit — annotate launchpad against existing specs

Retroactive annotation of launchpad legacy code against existing REQs in `openspec/specs/`. Two concurrent activities:
...
2. **File-docblock annotation** — Bucket 1 files identified by `openspec/coverage-report.json` (generated 2026-05-24) are tagged at file-docblock level with `@spec openspec/changes/retrofit-2026-05-24-annotate-launchpad/tasks.md#task-N` where missing.
