...
TEC_CATEGORY_MAP = {
    ...
    "scm": "inkoop",
    "supplier relationship management": "inkoop",
    "srm": "inkoop",
    "service parts planning": "inkoop",
    "production and supply planning": "erp",
    "manufacturing process management": "erp",
    "mpm": "erp",
    "product lifecycle management": "erp",
    "plm": "erp",
    "product development": "erp",
    "transportation management": "inkoop",
    "radio frequency identification": "inkoop",
    "rfid": "inkoop",
    "regulatory and compliance": "zaaksysteem",
    "task and project management": "projectmanagement",
    "software test tools": "erp",
    "staff scheduling": "hrm",
    "time and attendance": "hrm",
    "erp for manufacturing": "erp",
}
