 ...
 *
 * @category  Test
 * @package   OCA\LaunchPad\Tests\Unit\Search
...
class LaunchPadSearchProviderTest extends TestCase
{
    ...
    private LaunchPadSearchProvider $provider;
    ...
    protected function setUp(): void
    {
        ...
        $this->urlGenerator->method('linkToRouteAbsolute')
            ->willReturnCallback(
                static fn (string $routeName): string => 'https://nc.example/apps/launchpad/'
            );
        ...
        $this->provider = new LaunchPadSearchProvider(
    ...
    public function testGetIdReturnsLaunchPad(): void
    {
        self::assertSame('launchpad', $this->provider->getId());
    }
    ...
    public function testGetOrderBoostsLaunchPadRoute(): void
    {
        self::assertSame(5, $this->provider->getOrder('launchpad.page.index', []));
    }
