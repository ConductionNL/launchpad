...
- Trigger on push to the `development` branch (matching Pipelinq's pattern)
...
- GIVEN a developer pushes documentation changes to the `development` branch
- WHEN the GitHub Actions workflow runs
- THEN the site is built and deployed to the `gh-pages` branch

#### Scenario: Pull request does not deploy

- GIVEN a developer opens a pull request targeting `development`
